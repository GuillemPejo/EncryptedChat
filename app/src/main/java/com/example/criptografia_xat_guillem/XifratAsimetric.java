...
public class XifratAsimetric {
    private Map<String, Object> keys;
    private PrivateKey privateKey;
    private PublicKey publicKey;


    public XifratAsimetric() throws Exception {
    ...
    public static String encryptMessage(String plainText, PrivateKey privateKey) throws Exception {
        ...
        System.out.println("MISSATGE XIFRAT AMB ASIMETRIC CORRECTAMENT: "+ Base64.getEncoder().encodeToString(cipher.doFinal(plainText.getBytes())));
